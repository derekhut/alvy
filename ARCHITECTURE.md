...
- **Current subjects:** TOEFL word roots (30 roots × 5 words), AP Psychology (26 concepts / 130 terms), AP CSP (20 concepts / 72 terms), AP World History (batches 1-3: 15 concepts / 191 terms)
...
| `src/data/whap.json` | AP World History batches 1-3: 15 concepts × ~6-22 terms = 191 terms. |
