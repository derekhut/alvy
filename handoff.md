...
Status: V1 SHIPPED as `@derekhut/alvy@1.0.0` | V2 IN PROGRESS (Phase 1 COMPLETE, Phase 2 next) | AP Psych LIVE | AP CSP LIVE | AP WHAP batches 1-3 LIVE (15 concepts / 191 terms) | Update checker LIVE | Gamification Phase A LIVE (levels, ASCII art avatars, profile, composite score)
