...
import { getAllTopics, getTopicCount, getRelatedMeanings, getDistractorMeaning } from "../lib/csp-db.js";
...
const cspLabels: RootLessonLabels = {
  unitLabel: "概念",
  wordListIntro: "这个概念的核心术语:",
};

export default function CspReview() {
