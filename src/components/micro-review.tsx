...
import { getAllTopics, getTopicCount, getRelatedMeanings, getDistractorMeaning } from "../lib/micro-db.js";
...
const microLabels: RootLessonLabels = {
  unitLabel: "概念",
  ...
  if (state.phase === "empty") {
    return (
      <Box flexDirection="column" paddingLeft={2} paddingY={1}>
        ...
        <Text>先运行 alvy micro 学习新概念吧！</Text>
